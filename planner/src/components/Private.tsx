  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-line bg-paper p-5 shadow-sm">
          <div>
            <h3 className="font-semibold">Idea board</h3>
            <p className="text-sm text-ink-2">Dresses, decor, flowers — only visible to you.</p>
          </div>
          <Link href="/private/ideas" className="rounded-full bg-sage-deep px-4 py-2 text-sm font-semibold text-[#F7F3EA]">
            Open idea board →
          </Link>
        </div>
